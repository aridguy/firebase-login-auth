...
import { doc, setDoc, updateDoc, collection, addDoc, serverTimestamp, onSnapshot, orderBy, query, where } from 'firebase/firestore';
    ...
    >
      <div className="row justify-content-center">
        <div className="col-12 col-md-8 col-lg-6">
          ...
          >
            <div className="card-header d-flex justify-content-between align-items-center" style={{ background: 'transparent', borderBottom: `1px solid ${theme.borderColor}` }}>
              ...
              <div className="d-flex align-items-center gap-2">
                ...
                >
                  {getInitials(auth.currentUser.displayName || auth.currentUser.email)}
                </div>
                <button
              ...
              <div className="mb-2">
                ...
                <ul className="list-inline mb-0">
                  {onlineUsers.map((name, idx) => (
                    <li key={idx} className="list-inline-item badge bg-success text-light mx-1" style={{ fontSize: '1em', borderRadius: 12 }}>
                      {name}
                    </li>
                  ))}
                </ul>
